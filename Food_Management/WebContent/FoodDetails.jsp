...
<button class="ui btn right floated labeled icon button"  onclick="document.location='AddFood.jsp'">
		...
		<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.3/html2pdf.bundle.min.js"></script>
				<h1 class="col-md-8 title2">Details of Food Varieties</h1>
				...
				<td><a href="Update_fromF.jsp?foodcode=<%=resultSet.getString("Food_Code")%>">Update<i class="edit outline icon"></i></a></td>
				<td><a href="Delete_fromF.jsp?foodcode=<%=resultSet.getString("Food_Code")%>">Delete<i class="trash icon"></i></a></td>
				</tr>
				<%
				}
				connection.close();
			...
			<a href = "ReportFile.jsp"> <button class="ui btn right floated labeled icon button"  >
					View Report<i class="download icon"></i></button></a>
			</div>
			</div>
